...
function setBotResponse(val) {
	setTimeout(function () {
		if (val.length < 1) {
			...
			msg = 'I couldn\'t get that query. Can you be more specific or can you try asking something else!';

			var BotResponse = '<img class="botAvatar" src="./static/img/MSIT.png"><p class="botMsg">' + msg + '</p><div class="clearfix"></div>';
			...
			for (i = 0; i < val.length; i++) {
				...
				if (val[i].hasOwnProperty("text")) {
					var BotResponse = '<img class="botAvatar" src="./static/img/MSIT.png"><p class="botMsg">' + val[i].text + '</p><div class="clearfix"></div>';
					$(BotResponse).appendTo('.chats').hide().fadeIn(1000);
				}
